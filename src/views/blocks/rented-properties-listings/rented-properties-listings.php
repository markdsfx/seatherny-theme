<?php
/**
 * Rented Properties Block Template
 *
 * @package SDEV
 * @subpackage SDEV WP
 ...
 */  
    ...
    $class_name = 'block--custom-layout__rented-properties-listings';
                    ...
                    <div class="grid-item">
                        ...
                        <div class="listing-information">
                            ...
                            <div class="additional-information">
                                <div class="bedroom">
                                    <img class="icon" src="<?= \SDEV\Utils::getThemeResourcePath('assets/images/icon-bedroom.png') ?>">
                                    <small><?= $bedroom ?>BR Fully Furnished</small>
                                </div>
                                <div class="parking">
                                    <img class="icon" src="<?= \SDEV\Utils::getThemeResourcePath('assets/images/icon-parking.png') ?>">
                                    <small><?= $parking ?>Parking Slot</small>
                                </div>
                            </div>

                            <div class="listing-details">
                                <div class="col">
                                    <p class="price">&#8369;<?= $rate ?>/mo</p>
                                </div>
                            </div>
                        </div>
                    </div>
